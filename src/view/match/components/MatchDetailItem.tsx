...
import {MatchItem,SummonerDetailInfo,MaxValueList} from "../../../interface/MatchDetail";
import {useContext} from "react";


export default function ({isLeft,detailInfo,showTypeKey,showTypeIndex}:MatchItem) {
